...
<body>
<%
List list = (List)request.getAttribute("TEACHERCOMMENTLIST");
    		...
    		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      			<tr>
        			<td width="4%" height="20" bgcolor="d3eaef" class="STYLE10">
        				<div align="center">
        					<form action="/Nursery/inqteachercomment" method="post">
          						<label>教师：</label><input type="text" name="teacher_user_name" size = "15" value="${ON_SELECT_TEACHER_USER_NAME }"/> |
          						<label>评价等级：</label>
          						<select name="grade">
    		...
    		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      			<tr>
        			...
        			<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">评价等级</span></div></td>
       			 	<td width="50%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">评价内容</span></div></td>
				...
				<tr>
			        ...
			        <td height="20" bgcolor="#FFFFFF">
			        	<div align="center" class="STYLE21">
							...
							%>
								<a href="/Nursery/deleteteachercomment?TUN=<%=map.get("id") %>">删除</a>
							<%
							}
							%>
						</div>
