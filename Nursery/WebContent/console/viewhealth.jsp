  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      <tr>
        ...
        <td width="25%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10"><input type="text" name="check_date"  value="${HEALTHINFO.check_date}" readonly /></span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">身高</span></div></td>
        <td width="25%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10"><input type="text" name="height" size="10"  value="${HEALTHINFO.height}" readonly/>厘米</span></div></td>
      </tr>

	<tr>
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19">体重</span></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><input type="text" name="weight" size="10"   value="${HEALTHINFO.weight}" readonly/>公斤</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">年龄</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><input type="text" name="age" size="10"  maxlength="2"  value="${HEALTHINFO.age}" readonly/> 岁</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">视力</div></td>
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">左：<input type="text" name="left_sight" size="10"   value="${HEALTHINFO.left_sight}" readonly/> 右：<input type="text" name="right_sight" size="10" value="${HEALTHINFO.right_sight}" readonly/></div></td>
      </tr>
	<tr>
      ...
      <tr>
        <td colspan="6" height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19"><textarea name = "description" cols="100" rows="10"  readonly>${HEALTHINFO.description}</textarea></span></div></td>
      </tr>
