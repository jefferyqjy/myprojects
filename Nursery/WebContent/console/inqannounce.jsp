          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">公告查询</span></td>
              </tr>
            </table></td>
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      <tr>
        <td width="4%" height="20" bgcolor="d3eaef" class="STYLE10"><div align="center">
        	<form action="/Nursery/inqannounce" method="post">
          		标题：<input type="text" name="title" size = "15" value="${ON_SELECT_TITLE }"/> | 
          		科目： 
          		<select name="subject" >
   ...
   <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      <tr>
        ...
        <td width="16%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">科目</span></div></td>
        <td width="16%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">创建老师</span></div></td>
	...
	<%
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><%=map.get("title") %></div></td>
        ...
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"> <a href="/Nursery/announcemanager?type=view&id=<%=map.get("id") %>">查看</a> <%
	if ("admin".equals(userRole)) {
		%> | <a href="/Nursery/announcemanager?type=delete&id=<%=map.get("id") %>">删除</a> | <a href="/Nursery/announcemanager?type=viewupdate&id=<%=map.get("id") %>">修改</a><%
		}
	%>
		</div></td>
      </tr>
