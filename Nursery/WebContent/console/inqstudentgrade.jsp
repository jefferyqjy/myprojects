...
<body>
<%
List list = (List)request.getAttribute("STUDENTGRADELIST");
	            				...
	            				<td>
	            					<table width="100%" border="0" cellspacing="0" cellpadding="0">
	              						<tr>
	                						...
	                						<td width="94%" valign="bottom"><span class="STYLE1">学生成绩查询</span></td>
	              						</tr>
	            					</table>
	           					</td>
	    ...
	    <td>
	    	<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
	      		<tr>
	        		...
	        		<td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">学期</span></div></td>
					...
					<tr>
			        	...
			        	<td height="20" bgcolor="#FFFFFF">
	        				<div align="center" class="STYLE21"> 
								...
								%> 
									| <a href="/Nursery/studentgrademanager?type=delete&id=<%=map.get("id") %>">删除</a> | <a href="/Nursery/studentgrademanager?type=viewupdate&id=<%=map.get("id") %>">修改</a>
								<%
								}
								%>
							</div>
