          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">学生健康状况查询</span></td>
              </tr>
            </table></td>
   ...
   <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      <tr>
        ...
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">体重</span></div></td>
	...
	<%
        ...
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"> <a href="/Nursery/healthmanager?type=view&id=<%=map.get("id") %>">查看</a> <%
	if ("admin".equals(userRole)) {
		%> | <a href="/Nursery/healthmanager?type=delete&id=<%=map.get("id") %>">删除</a> | <a href="/Nursery/healthmanager?type=viewupdate&id=<%=map.get("id") %>">修改</a><%
		}
	%>
		</div></td>
      </tr>
