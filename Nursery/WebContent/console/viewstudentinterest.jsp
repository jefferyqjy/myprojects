...
<body>
<form action="/Nursery/interestmanager?type=add" method="post">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">查看学生兴趣班信息</span></td>
              </tr>
            </table></td>
    		...
    		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
    			<tr>
        			...
        			<td width="25%" height="20" bgcolor="d3eaef" class="STYLE6">
        				<div align="center"><span class="STYLE10">兴趣班</span></div>
        			</td>
      			</tr>
      			<tr>
        			<td width="20%" height="20" bgcolor="d3eaef" class="STYLE6">
        				<div align="center">
        					<span class="STYLE10">${STUDENTINTEREST.student_bodycard}</span>
        				</div>
        			</td>
        			<td width="25%" height="20" bgcolor="d3eaef" class="STYLE6">
        				<div align="center"><span class="STYLE10">${STUDENTINTEREST.interestInfo}</span></div>
        			</td>
      			</tr>
    		</table>
    	</td>
