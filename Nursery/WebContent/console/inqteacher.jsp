...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">教师信息查询</span></td>
              </tr>
            </table></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      <tr>
        <td width="4%" height="20" bgcolor="d3eaef" class="STYLE10"><div align="center"><form action="/Nursery/inqteacher" method="post">
          用户名：<input type="text" name="teacher_user_name" size = "15" value="${ON_SELECT_TEACHER_USER_NAME }"/> | 姓名： <input type="text" name="teacher_name" value="${ON_SELECT_TEACHER_NAME }" size = "15"/> | 学科 :
          ...
          <option value="7">电脑</option></select> <input type="submit" value="查询" /> <font color="red">${Error}</font><font color="green">${Succ}</font></form>
        </div></td>
      </tr>
    </table></td>
  </tr>
  ...
  if (list != null && list.size() > 0) {
   ...
   <tr>
	...
	<tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19"><%=map.get("user_name") %></span></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><%=map.get("name") %></div></td>
