...
<head>
<title> </title>
<link rel="stylesheet" type="text/css" href="/libmanage/admin/commfiles/css/login.css" />
	   ...
	   <div style="margin-left:180px; padding-top:12px; width:260px; overflow:hidden">
		 <table border="0" cellpadding="0" cellspacing="0" class="margin-bottom">
		  ...
		  <tr>
			...
			<td><input name="upass" type="password"
		   ...
		   <tr>
			...
			<td><label>
			  <input name="utype" type="radio" id="utype" value="读者" checked="checked" />
			读者
