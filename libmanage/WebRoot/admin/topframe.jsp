...
<body  onunload="checkout();"  style=" background-image: url(/libmanage/admin/commfiles/images/index_top_bg.gif); background-repeat: repeat-x;">
	 <div class="header_content">
	 <div class="logo" >
	<div style="height: 28px"></div>
	 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	 <strong>
	 <font style="font-family: 华文行楷;font-size: 32px" color="#3995FF">图书管理系统</font>
	 </strong>
	 </div>
	 <div class="right_nav">
	 <div class="text_left">
...
%>
	 ...
	 <a href="javascript:parent.manFrame.location.replace('<%=admin %>')" class="link_a">个人信息</a></div>
		 ...
		 <div class="text_right"><a href="javascript:top.location='/libmanage/index.jsp'" class="link_a">退出系统</a></div>
