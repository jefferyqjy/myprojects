...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="stylesheet"
			href="/libmanage/admin//commfiles/css/common.css" type="text/css" />
		<title>管理导航区域</title>
...
%>
	...
	<body>
		<div id="nav">
			<ul>
				<%
					if (utype.equals("管理员")) {
				%>
				<li id="man_nav_1" onclick="list_sub_nav(id,'业务信息')"
					class="bg_image_onclick">
					业务信息
				</li>
				<li id="man_nav_2" onclick="list_sub_nav(id,'信息管理')"
					class="bg_image">
					信息管理
				</li>
				<li id="man_nav_3" onclick="list_sub_nav(id,'统计分析')"
					class="bg_image">
					统计分析
				</li>
				<li id="man_nav_6" onclick="list_sub_nav(id,'属性配置')"
					class="bg_image">
					属性配置
				</li>
				<li id="man_nav_8" onclick="list_sub_nav(id,'系统管理')"
					class="bg_image">
					系统管理
				</li>
				<li id="man_nav_7" onclick="list_sub_nav(id,'个人信息')"
					class="bg_image">
					个人信息
				</li>
				<%
				...
				%>
				<li id="man_nav_1" onclick="list_sub_nav(id,'还借信息')"
					class="bg_image_onclick">
					还借信息
				</li>
				<li id="man_nav_2" onclick="list_sub_nav(id,'信息查询')"
					class="bg_image">
					信息查询
				</li>
				<li id="man_nav_3" onclick="list_sub_nav(id,'个人信息')"
					class="bg_image">
					个人信息
				</li>
				<%
		...
		<div id="sub_info">
			&nbsp;&nbsp; &nbsp;
			<span id="show_text">欢迎使用图书管理系统</span>
		</div>
<script>
var preClassName = "man_nav_1";
function list_sub_nav(id, name) {
		alert(id+"，"+name);
}
