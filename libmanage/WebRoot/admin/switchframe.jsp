...
function Submit_onclick(){
	if(parent.myFrame.cols == "200,7,*") {
		...
		document.getElementById("ImgArrow").src="/libmanage/admin/commfiles/images/switch_right.gif";
		document.getElementById("ImgArrow").alt="打开左侧导航栏";
	} else {
		parent.myFrame.cols="200,7,*";
		document.getElementById("ImgArrow").src="/libmanage/admin/commfiles/images/switch_left.gif";
...
function MyLoad() {
	if(window.parent.location.href.indexOf("MainUrl")>0) {
		window.top.midFrame.document.getElementById("ImgArrow").src="/libmanage/admin/commfiles/images/switch_right.gif";
	}
}
</script>
<body onload="MyLoad()">
