...
public class Info {
	 ...
	 public static CommonDAO getDao(HttpServletRequest request)
	    {
		 CommonDAO ad= (CommonDAO) WebApplicationContextUtils
	    	.getRequiredWebApplicationContext(request.getSession().getServletContext()).getBean("CommonDAO");
	    	return ad;
	    }
	 ...
	 public static String tform(HashMap map)
		{
	    	...
	    	jscode+="{\n";
	    	 ...
	    	 while(it.hasNext())
	    	 {
	    	  ...
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt\").src=\"/libmanage/upfile/"+map.get("filename")+"\";\n";
	    	  jscode+="}\n";
	...
	System.out.print(Info.getDateStr());
	 ...
	 /**
		...
		{
			String jscode = "";
			jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg()\" src=\"/libmanage/js/nopic.jpg\" id=txt height=\""+height+"\"/>";
