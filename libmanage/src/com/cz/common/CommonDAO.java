...
public class CommonDAO extends HibernateDaoSupport {
	...
	public void delete(String id, String entity) {
		try {
			getHibernateTemplate().delete(
					getHibernateTemplate().get("com.cz.entity." + entity,
							Integer.parseInt(id)));
		} catch (RuntimeException re) {
			throw re;
		}
	...
	public void delete(int id, String entity) {
		try {
			getHibernateTemplate().delete(
					getHibernateTemplate().get("com.cz.entity." + entity, id));
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public Object findById(java.lang.String id, String entity) {
		try {
			Object instance = getHibernateTemplate().get(
					"com.cz.entity." + entity, Integer.parseInt(id));
			return instance;
		} catch (RuntimeException re) {
			throw re;
		}
