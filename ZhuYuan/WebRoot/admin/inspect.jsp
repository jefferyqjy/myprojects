...
<div id="mainPanle" region="center" border="true" style="background:#f7f7f7; padding:5px;">
  <table width="100%">
    <thead>
      <tr>
        <td colspan="7" align="center" style="padding:5px;">患者检查管理</td>
      </tr>
      <tr>
        <td colspan="7" style="padding:5px;"><a href="javascript:void(0)" id="inspect_add">患者检查</a></td>
      </tr>
      <tr class="thead">
    ...
    %>
      <tr>
        ...
        <td align="center"><a href="<%=path %>/DelServlet?inspect=<%=alRow.get(0) %>">删除</a></td>
      </tr>
      <%}} %>
    </tbody>
  </table>
