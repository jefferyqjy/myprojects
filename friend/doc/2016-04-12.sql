...
-- 正在导出表  friend.com_pro_city 的数据：~3 rows (大约)
...
-- 正在导出表  friend.com_pro_friend_group 的数据：~9 rows (大约)
...
-- 正在导出表  friend.com_pro_friend_group_user 的数据：~8 rows (大约)
...
-- 正在导出表  friend.com_pro_message 的数据：~8 rows (大约)
...
-- 正在导出表  friend.com_pro_province 的数据：~0 rows (大约)
...
-- 正在导出表  friend.com_pro_subject 的数据：~0 rows (大约)
...
-- 正在导出表  friend.com_pro_university 的数据：~3 rows (大约)
