			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> 表单元素: 省份</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form:form method="Post" action="/friend/admin/province/add.spring" commandName="provinceBean" id="provinceBean_form" class="form-horizontal">
							<fieldset>
							  ...
							  <div class="control-group">
								<label class="control-label" for="focusedInput">拼音</label>
							  	<div class="controls">
								  <form:input class="input-xlarge focused" id="pinyin" path="pinyin" type="text" />
							  	</div>
							  </div>
