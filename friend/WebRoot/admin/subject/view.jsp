			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form:form method="Post" action="/friend/admin/subject/add.spring" commandName="subjectBean" id="subjectBean_form" class="form-horizontal">
							<fieldset>
							  ...
							  <div class="control-group">
								<label class="control-label" for="focusedInput">大学</label>
							  	<div class="controls">
							  		<form:input cssClass="input-xlarge focused" id="universityName" path="universityName" />
							  	</div>
							  </div>
							</fieldset>
						</form:form>
