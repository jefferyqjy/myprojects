			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form:form method="Post" action="/friend/admin/university/update.spring" commandName="universityBean" id="universityBean_form" class="form-horizontal">
							<fieldset>
								...
								<label class="control-label" for="focusedInput">CITY</label>
							  	<div class="controls">
							  	 <form:select path="city.id" data-rel="chosen" >
									<form:options items="${CityBeanList}" itemValue="id" itemLabel="name"/>
								  </form:select>
							  	</div>
							  </div>
