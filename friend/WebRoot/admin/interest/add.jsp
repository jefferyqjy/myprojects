		...
		<div class="row-fluid">
			...
			<div id="content" class="span10">
				<div>
					<ul class="breadcrumb">
						<li>
							<a href="#">兴趣</a> <span class="divider">/</span>
						</li>
						<li>
							<a href="#"> 添加 </a>
						</li>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> 表单元素: 兴趣</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form:form method="Post" action="/friend/admin/interest/add.spring" commandName="interestBean" id="interestBean_form" class="form-horizontal">
							<fieldset>
