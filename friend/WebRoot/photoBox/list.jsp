...
<!--------------Navigation--------------->
		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div><a href="#newModal" role="button" class="btn" data-toggle="modal">创建新相册</a></div>
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> 我的相册</h2>
						<div class="box-icon">
	...
	<div class="modal hide fade" id="newModal" style="z-index:9999">
	  ...
	  <div class="modal-body" style="height:100px;">
	    <p>相册名称：  <input class="input-xlarge focused" id="photoBoxName"  type="text" /></p>
	  </div>
	  <div class="modal-footer">
	    <a href="#" class="btn" onclick="$('#newModal').modal('hide');
	    	$('.datatable').dataTable().fnDraw();">关闭</a>
	    <a href="#" class="btn btn-primary" onClick="addPhotoBox()">Save changes</a>
	  </div>
	</div>
		<tags:copyright/>
	...
	function addPhotoBox() {
		var url = "/friend/photoBox/add.spring";
		var name = $('#photoBoxName').val();
		var data = {name:name};
		 $.ajax({  
		        url : url,  
		        type : "POST",  
	...
	function initializeEvents() {
		$('.datatable').dataTable({
			...
			"bServerSide" : true,
			"sAjaxSource" : "/friend/photoBox/list.spring",
		    "sServerMethod" : "POST" ,
		    "bProcessing" : false,
		    "bPaginate": true,
			"bLengthChange" : true,
	...
	function createAction(id) {
		var inhtml = '<a class="btn btn-success" href="/friend/photoBox/view.spring?id=' + id + '">';
