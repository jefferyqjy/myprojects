					...
					<div class="box span12">
						<div>
							<a href="#" class="btn  btn-info" data-toggle="modal"
								...
								data-target="#myModal" title="上传照片" onClick="openUpload()"><i
								class="icon-upload icon-white"></i>上传照片</a>
						</div>
	...
	<div class="modal hide fade" id="myModal">
		...
		<div class="modal-body" style="min-height: 400px">
			...
			<div class="modal-footer">
				<a class="btn btn-success" style="margin-left: 10px"
					onclick="$('#multiple_file_upload').uploadify('upload','*')">开始上传</a>
				<a class="btn btn-success" style="margin-left: 10px"
					onclick="$('#multiple_file_upload').uploadify('cancel','*')">取消上传</a>
				<a href="#" data-dismiss="modal" class="btn"
					onclick="refresh()">关闭</a>
			</div>
		</div>
	</div>
