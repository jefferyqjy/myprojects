...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           ...
           {
               var strUrl = "<%=path %>/admin/yuyue/liuyanHuifu.jsp?id="+id;
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align="center" bgcolor="#FAFAF1" height="22">
				    <td width="5%">序号</td>
				    <td width="10%">租房信息</td>
				 <s:if test="${isType eq 'pj' }">  
					<td width="10%">评价者ID</td>
					<td width="10%">评价语</td>					
					<td width="10%">评价时间</td>
					</s:if> 
					<s:if test="${isType eq 'ly' }">  
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<s:if test="${isType eq 'pj' }">  
					<td bgcolor="#FFFFFF" align="center">
						<s:property value="#yuyue.pinjiaremark"/>
					</td>					
					<td bgcolor="#FFFFFF" align="center">
						<s:property value="#yuyue.pinjiashij"/>
					</td>
					</s:if>
						<s:if test="${isType eq 'ly' }">  
					<td bgcolor="#FFFFFF" align="center">
					...
					<td bgcolor="#FFFFFF" align="center">
					<input type="button" value="删除" onclick="yuyueDel(<s:property value="#yuyue.id"/>)"/>
					<s:if test="${isType eq 'ly' }">  
					<input type="button" value="回复" onclick="liuyanHuifu(<s:property value="#yuyue.id"/>)"/>
					</s:if>
					</td>
				</tr>
				</s:iterator>
