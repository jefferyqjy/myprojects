		...
		<body>
			...
			<div class="tab-content default-tab" id="tab1">
				<fieldset>
					...
					<p>
						<b><public:i18n key="stuname" module="applyInfo"></public:i18n>:</b>
						<label>${result.stuname}</label>
					</p>
					<p>
						<b><public:i18n key="status" module="applyInfo"></public:i18n>:</b>
						<label>${result.status}</label>
					</p>
					<p>
						<b><public:i18n key="relname" module="applyInfo"></public:i18n>:</b>
						<label>${result.relname}</label>
					</p>
					<p>
						<b><public:i18n key="phone" module="applyInfo"></public:i18n>:</b>
						<label>${result.phone}</label>
					</p>
					<p>
						<b><public:i18n key="content" module="applyInfo"></public:i18n>:</b>
