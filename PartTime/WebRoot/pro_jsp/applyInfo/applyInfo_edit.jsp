		...
		<body>
			...
			<form action="applyInfo/applyInfo_update.do" method="post" name="mainform">
				...
				<input type='hidden' name='id' value='${result.id }' />
					<tr>
					   <td>
						   <public:i18n key="parttimetitle" module="applyInfo"></public:i18n>:
					   </td>
					   <td>
					...
					<tr>
					   <td>
						   <public:i18n key="relname" module="applyInfo"></public:i18n>:
					   </td>
					   <td>
						   ${result.relname}
					   </td>
					...
					<tr>
					   <td>
						   <public:i18n key="phone" module="applyInfo"></public:i18n>:
					   </td>
					   <td>
						   ${result.phone}
					   </td>
