			...
			<div class="modal-content">
				...
				<div class="modal-body" style="max-height: 500px;overflow-y: scroll;">
					...
					<div class="blue clearfix">
						...
						<input type="text" id="promoter" class="width-100" />
					</div>
        	...
        	jQuery(function($) {
        		...
        		$(document).keydown(function(event) {
					...
					if (key == 13) {
						if ($("#search-input").val() == "") {
	    			    	...
	    			    	$.ajax({
	            				dataType : "json",
	            				url : "${contextPath}/sys/activity/getApplyActivity",
	            				type : "post",
	            				data : {
        		...
        		$("#editInformationButton").bind("click", function() {
        			...
        			if(null == selectedId){
        				...
        				$("#promoter").val(jQuery(grid_selector).jqGrid("getRowData",jQuery(grid_selector).jqGrid("getGridParam", "selrow")).promoter);
        			}
        		});
        		...
        		$("#informationForm").on("submit", function(e) {
        			if ($("#title").val() == "") {
    			    	...
    			    	$.ajax({
            				dataType : "json",
            				url : "${contextPath}/sys/activity/operateDict?oper=save",
            				type : "post",
            				data : {
            					id : $("#id").val(),
            					title : $("#title").val(),
        			...
        			$("#informationForm2").on("submit", function(e) {
    			    	$.ajax({
            				dataType : "json",
            				url : "${contextPath}/sys/activity/operateDict?oper=reviewed",
            				type : "post",
            				data : {
            					id : $("#id2").val(),
