	...
	<div class="col-xs-12">
		<div class="well well-sm">
			...
			<shiro:lacksPermission name="${ROLE_KEY}:information:edit">
             ...
             <shiro:hasPermission name="${ROLE_KEY}:information:edit">
				<a id="lookButton" role="button" class="btn btn-purple btn-sm" data-toggle="modal">
					查看投票结果
				</a>
			</shiro:hasPermission>
		</div>
...
<div id="look-table" class="modal fade" tabindex="-1" data-backdrop="static">
	<div class="modal-dialog" style="min-width: 820px;">
		<form id="informationForm">
			<div class="modal-content">
				<div class="modal-header no-padding">
				...
				<div class="modal-body" style="max-height: 500px;overflow-y: scroll;">
					...
					<div class="blue clearfix">
						...
						<input type="text" id="title2" class="width-100" />
					</div>
        ...
        $(".page-content-area").ace_ajax("loadScripts", scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		$(document).keydown(function(event) {
					...
					if (key == 13) {
						if ($("#search-input").val() == "") {
	    			    	...
	    			    	$.ajax({
	            				dataType : "json",
	            				url : "${contextPath}/sys/activity/geActivity",
	            				type : "post",
	            				data : {
        		...
        		jQuery(grid_selector).jqGrid({
        			...
        			editurl : "${contextPath}/sys/activity/operateDict"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
        		...
        		$("#lookButton").bind("click", function() {
        			...
        			if(null == selectedId){
        				...
        				$("#look-table").modal("toggle");
        				$("#title2").val(jQuery(grid_selector).jqGrid("getRowData",jQuery(grid_selector).jqGrid("getGridParam", "selrow")).title);
        		...
        		$("#informationForm").on("submit", function(e) { 
   			    	$.ajax({
           				dataType : "json",
           				url : "${contextPath}/sys/voter/operateDict?oper=save",
           				type : "post",
           				data : {
           					aid : $("#aid").val(),cid : $("#list4").jqGrid('getGridParam','selrow'), 
           				},
           				complete : function(xmlRequest) {
           					
           					var message = xmlRequest.responseJSON.message;
        		...
        		if(<shiro:hasPermission name="${ROLE_KEY}:information:export">true</shiro:hasPermission><shiro:lacksPermission name="${ROLE_KEY}:information:export">false</shiro:lacksPermission>){
    				jQuery(grid_selector).jqGrid("navButtonAdd", pager_selector,{
   				       ...
   				       onClickButton : function () { 
   				    	   ...
   				    	   var form = "<form name='csvexportform' action='${contextPath}/sys/activity/operateDict?oper=excel' method='post'>";
