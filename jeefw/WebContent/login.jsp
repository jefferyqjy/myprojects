...
<html lang="zh-cn">
	<head>
		...
		<meta charset="utf-8" />
		<title>候选人投票系统  - 登录</title>

		<meta name="description" content="候选人投票系统 |登录页面" />
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<!-- <input id="loginEmail" name="email" type="text" class="form-control" placeholder="学号" data-rel="tooltip" title="学号作为账号" data-placement="right" /> -->
															<input id="loginEmail" name="email" type="text" class="form-control" placeholder="学号" />
										...
										<div class="widget-main">
											...
											<form id="validationRetrieveForm" method="post" action="#">
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="retrieveEmail" name="email" type="email" class="form-control" placeholder="学号" title="学号作为用户名" />
										...
										<div class="widget-main">
											...
											<form id="validationRegisterForm" method="post" action="#">
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="email" name="email" type="email" class="form-control" placeholder="学号" title="学号用于登录和找回密码" />
															<i class="ace-icon fa fa-envelope"></i>
														</span>
													</label>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															...
															<span class="lbl">
																我已阅读并接受
																<a href="#" onclick="alert('用户协议：')">用户协议</a>
															</span>
														</span>
													</label>
