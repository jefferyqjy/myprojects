...
public class InformationController extends JavaEEFrameworkBaseController<Information> implements Constant {
	...
	public void getInformation(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List<Information> informationHTMLList = informationService.queryInformationHTMLList(queryResult.getResultList());
	...
	public void doSave(Information entity, HttpServletRequest request, HttpServletResponse response) throws IOException {
		ExtJSBaseParameter parameter = ((ExtJSBaseParameter) entity);
		if (CMD_EDIT.equals(parameter.getCmd())) {
			informationService.merge(entity);
	...
	public void deleteInformation(HttpServletRequest request, HttpServletResponse response, @RequestParam("ids") Long[] ids) throws IOException {
