		...
		<head>
			...
			<script type="text/javascript">
				function toPage(pageNum){
					var url = "exam/exam_query.do?curPage="+pageNum;
		...
		<body>
			...
			<div class="content-box-content">
				...
				<jsp:include page="/sys_jsp/notification.jsp"></jsp:include>
					<form id="searchForm" name="searchForm" action="exam/exam_query.do" method="post">
							...
							<table>
								...
								<c:forEach items="${result}" var="record">
									<tr>
										...
										<%if(!request.getSession().getAttribute(Const.Session.ADMIN_USER_TYPE).equals("2")) {%>
										<td>
											<a style="cursor: pointer;" onclick="gotoEdit('<%=basePath %>exam/exam_edit.do?id=${record.id }')" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
											<a style="cursor: pointer;" onclick="actionDel('<%=basePath %>exam/exam_del.do?id=${record.id }')" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a>
										</td>
										<%} %>
									</tr>
								</c:forEach>
