...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			...
			<div class="content-box-header">
				<h3><public:i18n key="function.add" module="exam"></public:i18n></h3>
				<ul class="content-box-tabs">
					<li><a href="#tab1" class="default-tab"><public:i18n key="function.add" module="exam"></public:i18n></a></li>
				</ul>
				<div class="clear"></div>
			</div>
			...
			<jsp:include page="/sys_jsp/notification.jsp"></jsp:include>
				<div class="tab-content default-tab" id="tab1">
					<form action="<%=basePath %>exam/exam_add.do" method="post" name="mainform">
					<table>
					<tr>
					    <td>
					...
					<tr>
					    ...
					    <td>
						    <input class="text-input small-input" type="text" id="subject" name="subject" rule="CHAR_M_20"/>
						<span id="subject_errorMsg" class="input-notification png_bg"></span>
					    </td>
					</tr>
					<tr>
					    <td>
					...
					<tr>
					    ...
					    <td>
						    <input class="text-input small-input" type="text" id="place" name="place" rule="CHAR_M_20"/>
