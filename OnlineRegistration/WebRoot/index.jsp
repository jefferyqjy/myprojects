 ...
 <head>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<br/><br/>
			<font style="font-size: 20px"><public:i18n key="system.name" module="system"></public:i18n></font>
		  
			<!-- Sidebar Profile links -->
			<div id="profile-links">
				<public:i18n key="index.hello" module="system"></public:i18n>, <a href="#" title="Edit your profile">
				<%
					String loginType = request.getSession().getAttribute(Const.Session.ADMIN_USER_TYPE)+"";
					if ("2".equalsIgnoreCase(loginType)) {
				%>	
				<%=request.getSession().getAttribute(Const.Session.SES_USER_NAME) %> 
				<%	
					} else {
				%>	
				<%=request.getSession().getAttribute(Const.Session.ADMIN_USER_NAME) %> 	
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<iframe width="100%" style="height: 550px" scrolling="auto" frameborder="no" src="<%=basePath %>shortcut.jsp" id="rightMain" name="right" id="right"></iframe>
