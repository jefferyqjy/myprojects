...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			...
			<h3><public:i18n key="function.edit" module="customerinfo"></public:i18n></h3>
			<ul class="content-box-tabs">
				<li><a href="#tab1" class="default-tab"><public:i18n key="function.edit" module="customerinfo"></public:i18n></a></li>
			</ul>
			<div class="clear"></div>
			</div>
			...
			<form action="customerinfo/customerinfo_update.do" method="post" name="mainform">
				<table>
