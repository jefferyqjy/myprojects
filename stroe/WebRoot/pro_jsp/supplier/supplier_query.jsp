		...
		<head>
			...
			<script type="text/javascript">
				function toPage(pageNum){
					var url = "supplier/supplier_query.do?curPage="+pageNum;
		...
		<body>
			...
			<div class="content-box-content">
				...
				<jsp:include page="/sys_jsp/notification.jsp"></jsp:include>
					<form id="searchForm" name="searchForm" action="supplier/supplier_query.do" method="post">
								...
								<c:forEach items="${result}" var="record">
									<tr>
										...
										<!--<td><a href="<%=basePath %>supplier/supplier_detail.do?id=${record.id }" title="title">${record.id }</a></td>-->
											...
											<td>${record.remark}</td>
										<td>
											<a style="cursor: pointer;" onclick="gotoEdit('<%=basePath %>supplier/supplier_edit.do?id=${record.id }')" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
											<a style="cursor: pointer;" onclick="actionDel('<%=basePath %>supplier/supplier_del.do?id=${record.id }')" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a>
										</td>
									</tr>
								</c:forEach>
								</tbody>
