...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			...
			<div class="content-box-header">
				<h3><public:i18n key="function.manager" module="finance"></public:i18n></h3>
				<ul class="content-box-tabs">
					<li><a href="#tab1" class="default-tab"><public:i18n key="function.list" module="finance"></public:i18n></a></li>
				</ul>
				<div class="clear"></div>
			</div>
					...
					<c:choose>
						...
						<c:otherwise>
							<table>
								...
								<th><public:i18n key="financetype" module="finance"></public:i18n></th>
								<th><public:i18n key="supname" module="finance"></public:i18n></th>
								<th><public:i18n key="custname" module="finance"></public:i18n></th>
								<th><public:i18n key="datefin" module="finance"></public:i18n></th>
								<th>金额</th>
								<th><public:i18n key="remark" module="finance"></public:i18n></th>
								...
								<c:forEach items="${result}" var="record">
									<tr>
										...
										<!--<td><a href="<%=basePath %>finance/finance_detail.do?id=${record.id }" title="title">${record.id }</a></td>-->
											<td>${record.financetype}</td>
											<td>${record.supname}</td>
											<td>${record.custname}</td>
											<td>${record.datefin}</td>
											<td>${record.totalmoney}</td>
											<td>${record.remark}</td>
										<td>
											<a style="cursor: pointer;" onclick="gotoEdit('<%=basePath %>finance/finance_edit.do?id=${record.id }')" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
											<a style="cursor: pointer;" onclick="actionDel('<%=basePath %>finance/finance_del.do?id=${record.id }')" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a>
										</td>
									</tr>
								</c:forEach>
								</tbody>
