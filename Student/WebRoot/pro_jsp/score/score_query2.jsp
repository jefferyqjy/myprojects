...
<html>
		...
		<script type="text/javascript">
			function toPage(pageNum){
				var url = "score/score_query2.do?curPage="+pageNum;
		...
		<body id="page">
			...
			<div class="pageTitle">当前位置：统计成绩</div>
			<div class="pageColumn">
			<form id="searchForm" name="searchForm" action="score/score_query2.do" method="post">
				<fieldset>
					<legend>科目</legend>
