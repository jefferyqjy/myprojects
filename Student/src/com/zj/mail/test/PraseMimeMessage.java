...
public class PraseMimeMessage {
	 ...
	 * 保存到数据库
	 */
	public void saveAttachMentToDB(Part part) throws Exception {
		String fileName = "";
		if (part.isMimeType("multipart/*")) {
			Multipart mp = (Multipart) part.getContent();
			for (int i = 0; i < mp.getCount(); i++) {
	...
	public static void main(String args[]) throws Exception {
		String host = "pop.163.com";// ��POP3.163.com��
		String username = "yaominhua-1314";// ��yuxia2217��
		String password = "storm0";// ��........��
		...
		for (int i = 0; i < message.length; i++) {
			...
			pmm.setDateFormat("yy��MM��dd�ա�HH:mm");
			System.out.println("Message��" + i + "��sentdate:��"
					+ pmm.getSentDate());
