												...
												<td bgcolor="#f3ffe3" height="390" valign="top">
													<table>
														<tr align="center" height="50">
															<td valign="top" class="mt10">
																会员卡号：<input type="text" name="cardNo" />
																...
																<input type="button" name="button" class="btn btn82 btn_add" value="新增" style='font-size: 11px' onClick="doAdd();">
															</td>
														</tr>
													</table>
													<table>
													...
													<table width="99%" border="0" align="center"
														...
														<tr>
															...
															<td width="20%" height="30" background="img/tab_14.gif"
																bgcolor="#FFFFFF" align="center">查看</td>
															<td width="20%" height="30" background="img/tab_14.gif"
														...
														<tbody align="center" onmouseover="changeto()"
															...
															<c:forEach var="mc" items="${membercards}" varStatus="item">
																<tr align="center" bgcolor="#FFFFFF" height="25">
																	...
																	<td>${mc.createTime}</td>
																	<td>
																		<a href="Membercard?operator=3&&mId=${mc.mId}">
																			<input type="button" name="button" class="btn btn82 btn_save2" value="查看"> 
																		</a>
																	</td>
																	<td>
																		<a href="Membercard?operator=4&&mId=${mc.mId}">
