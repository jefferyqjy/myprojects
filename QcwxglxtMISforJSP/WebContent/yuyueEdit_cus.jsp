												...
												<td bgcolor="#f3ffe3" height="390" valign="top"><table
														...
														<tr bgcolor="#f3ffe3">
															<td><c:if
																	...
																	<form name="edit_Form"
																		action="YuyueQuery?operatorStr=${operatorStr}"
																		method="post">
																		<table width="100%">
																			...
																			<tr height="30">
																				...
																				<c:if test="${operatorStr=='add'}">
																					<td align="left"><input type="text"
																						name="cusphone" value="${customer.cusphone}"
																						id="cusphone"></td>
																				</c:if>
																	...
																	<p align="center">
																		<input type=button name="delbut" value="请确认删除预约单"
																			onclick="window.location.href('YuyueQuery?operatorStr=${operatorStr}&&yID=${yuyue.yID}')"
