...
<script language="JavaScript">
	function doSearch() {
		if (document.all.searchValue.value == "") {
			...
			window.location.href = "CheckoutsQuery?currentPage=1&&pagerMethod=1&&operator=0&&queryName="
												...
												<td bgcolor="#f3ffe3" height="390" valign="top">
													...
													<table width="99%" border="0" align="center"
														...
														<tr>
															...
															<td width="6%" height="30" background="img/tab_14.gif"
																bgcolor="#FFFFFF" align="center">评价</td>
														</tr>
														<tbody align="center" onmouseover="changeto()"
															...
															<c:forEach var="item" items="${checkoutss}"
																...
																<tr align="center" bgcolor="#FFFFFF" height="25">
																	...
																	<td><a href="CheckoutsQuery?operator=3&&cID=${item.cID}">评价</a></td>
																</tr>
															</c:forEach>
														</tbody>
													</table>
