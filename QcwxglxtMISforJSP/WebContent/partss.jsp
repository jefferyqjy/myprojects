...
<script language="JavaScript">
	function doSearch() {
		if (document.all.searchValue.value == "") {
			...
			window.location.href = "Partss?currentPage=1&&pagerMethod=1&&p_operator=0&&queryName="
	...
	function doSearchAll() {
		window.location.href = "Partss?p_operator=1&&currentPage=1&&pagerMethod=1";
	}
	function doAdd() {
		window.location.href = "MaintainPartss?p_operatorStr=add&&operatorStr=0";
	}
</script>
									...
									<td height="30">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr align="center" style="font-size: 25px;">
												...
												<td width="1101" background="img/tab_05.gif">零件销售出库管理</td>
														...
														<tr align="center" height="50">
															<td valign="top" class="mt10">请选择查询条件:<select
																name="searchName" class="select">
																	<option value="partssID">销售编号</option>
																	<option value="customer.cusName">客户姓名</option>
																	<option value="employee.empName">员工姓名</option>
													...
													<table>
														<tr>
															<td><img src="img/311.gif" width="16" height="16" />
																<span class="STYLE4">零件销售出库信息列表</span></td>
														</tr>
													</table>
													<table width="99%" border="0" align="center"
														...
														<tr>
															...
															<td width="10%" height="30" background="img/tab_14.gif"
																bgcolor="#FFFFFF" align="center">客户名称</td>
															<td width="7%" height="30" background="img/tab_14.gif"
																bgcolor="#FFFFFF" align="center">总金额</td>
															<td width="10%" height="30" background="img/tab_14.gif"
																bgcolor="#FFFFFF" align="center">销售日期</td>
															<td width="7%" height="30" background="img/tab_14.gif"
																bgcolor="#FFFFFF" align="center">查看销售明细</td>
															<td width="7%" height="30" background="img/tab_14.gif"
																bgcolor="#FFFFFF" align="center">销售退货</td>
														</tr>
														<tbody align="center" onmouseover="changeto()"
															onmouseout="changeback()">
															<c:forEach var="item" items="${partsss}"
																varStatus="partsss">
																<tr align="center" bgcolor="#FFFFFF" height="35">
																	<td>${item.partssID}</td>
																	<td>${item.empName}</td>
																	<td>${item.cusName}</td>
																	<td>${item.partsstotal}</td>
																	<td>${item.ssdate}</td>
																	<td><a
																		href="Partss?p_operator=3&&partssID=${item.partssID}">查看销售明细</a></td>
																	<td><a
																		href="Partss?p_operator=4&&partssID=${item.partssID}">销售退货</a></td>
														...
														<tr>
															<td colspan="9">共${totalRows}行&nbsp;
																第${currentPage}页&nbsp; 共${totalPage}页&nbsp; <c:if
																	test="${p_operator==0}">
																	<a
																		href="Partss?p_operator=0&&queryName=${queryName}&&queryValue=${queryValue}&&currentPage=${currentPage}&&pagerMethod=1">首页</a>
																	<a
																		href="Partss?p_operator=0&&queryName=${queryName}&&queryValue=${queryValue}&&currentPage=${currentPage}&&pagerMethod=2">上一页</a>
																	<a
																		href="Partss?p_operator=0&&queryName=${queryName}&&queryValue=${queryValue}&&currentPage=${currentPage}&&pagerMethod=3">下一页</a>
																	<a
																		href="Partss?p_operator=0&&queryName=${queryName}&&queryValue=${queryValue}&&currentPage=${currentPage}&&pagerMethod=4">尾页</a>
																</c:if> <c:if test="${p_operator==1}">
																	<a
																		href="Partss?p_operator=1&&currentPage=${currentPage}&&pagerMethod=1">首页</a>
																	<a
																		href="Partss?p_operator=1&&currentPage=${currentPage}&&pagerMethod=2">上一页</a>
																	<a
																		href="Partss?p_operator=1&&currentPage=${currentPage}&&pagerMethod=3">下一页</a>
																	<a
																		href="Partss?p_operator=1&&currentPage=${currentPage}&&pagerMethod=4">尾页</a>
																</c:if>
															</td>
														</tr>
													</table></td>
