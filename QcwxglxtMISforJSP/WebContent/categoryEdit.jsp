									...
									<td height="30"><table width="100%" border="0"
											...
											<tr align="left">
												...
												<td width="1101" background="img/tab_05.gif"><img
													...
													class="STYLE4"> <c:if test="${operatorStr=='add'}"> 增加零件类别</c:if>
														<c:if test="${operatorStr=='modify'}">修改零件类别</c:if> <c:if
															test="${operatorStr=='delete'}">删除零件类别</c:if>
												</span></td>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td bgcolor="#f3ffe3" height="390" valign="top"><table
														...
														<tr bgcolor="#f3ffe3">
															<td><c:if
																	test="${operatorStr=='add' || operatorStr=='modify'}">
																	<form name="edit_Form"
																		action="CheckCategory?operatorStr=${operatorStr}"
																		method="post">
																		<table width="100%">
																			<c:if test="${operatorStr=='modify'}">
																				<tr height="30">
																					<td align="right"><font face="隶书">零件类别编号：</font>
																					</td>
																					<td align="left"><input type="text" readonly
																						style="background: #CCFFFF" name="kindID"
																						value="${category.kindID}"></td>
																				</tr>
																			</c:if>
																			<tr height="30">
																				<td align="right"><font face="隶书">零件类别名称：</font>
																				</td>
																				<td align="left"><input type="text"
																					name="kindName" value="${category.kindName}">
																			</tr>
																			<tr height="30">
																				<td align="right"><font face="隶书">零件类别描述：</font>
																				</td>
																				<td align="left"><input type="text"
																					name="description" value="${category.description}"></td>
																			</tr>
																			<tr height="30">
																				<td align="right"><input type="submit"
																					name="sub" class="btn btn82 btn_save2" value="确定">
																				</td>
																	...
																	<table align="center">
																		<tr height="30">
																			<td align="right">零件类别编号：</td>
																			<td align="left">${category.kindID}</td>
																		</tr>
																		<tr height="30">
																			<td align="right">零件类别名称：</td>
																			<td align="left">${category.kindName}</td>
																		</tr>
																		<tr height="30">
																			<td align="right">零件类别描述：</td>
																			<td align="left">${category.description}</td>
																		</tr>
																	</table>
																	<p align="center">
																		<input type=button name="delbut" value="请确认删除零件类别"
																			onclick="window.location.href('Category?operatorStr=${operatorStr}&&kindID=${category.kindID}')"
