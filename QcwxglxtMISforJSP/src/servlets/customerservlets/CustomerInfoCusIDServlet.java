 ...
 */
@WebServlet(name = "CustometInfoCusID", description = "CustometInfoCusID", urlPatterns = { "/CustometInfoCusID" })
public class CustomerInfoCusIDServlet extends HttpServlet {
	...
	public CustomerInfoCusIDServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			Customer customer= new CustomerDAO().findById(cusID);
			if (customer != null) {
